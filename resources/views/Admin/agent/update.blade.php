				...
				<div class="col-12">
				  ...
				  <div class="box box-default">
					...
					<div class="box-body wizard-content">
						...
						{{Form::model($agent,['url'=>route('UpdateAgent',$agent)])}}
						{{ csrf_field() }}
							<!-- Step 1 -->
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											{!! Form::text('name',$agent->name, ['class'=>'form-control', 'id' => 'name']) !!} </div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="lastName2">Code identification paiement</label>
											
											{!! Form::text('code_vente',$agent->code_vente, ['class'=>'form-control', 'id' => 'code_vente']) !!}</div>
									</div>
