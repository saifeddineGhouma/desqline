		...
		<section class="content">  
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="page-title">Dashboard Instapay</h3>
					...
					<div class="box box-inverse box-success">
					  <div class="box-body">
						...
						<div class="text-center my-2">
						  <div class="font-size-60">2500</div>
					...
					<div class="col-12">
						<div class="box">
							<div class="box-header with-border">						
								<h4 class="box-title">Liste factures</h4>
								<h6 class="box-subtitle">Export factures List to Copy, CSV, Excel, PDF & Print</h6>
							</div>
							<div class="box-body">						
