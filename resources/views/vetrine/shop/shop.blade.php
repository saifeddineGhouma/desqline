...
<a href="shop-product-ajax-page.php" data-lightbox="ajax">Quick View</a>
</div>
</div>
...
<div class="product">
<div class="product-image">
<a href="#"><img alt="Shop product image!" src="{{asset('images/shop/products/2.jpg')}}">
</a>
