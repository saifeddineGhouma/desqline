...
<?php
$title="Depanage Installine | Le premier site de vente en ligne des licence antivirus";
$author="INSPIRO";
...
<h1 class="text-uppercase text-medium">Depanage L'informaticien de confiance</h1>
