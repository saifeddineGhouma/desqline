...
<?php
$title="Service apres vente Installine | Le premier site de vente en ligne des licence antivirus";
$author="INSPIRO";
...
<h1 class="text-uppercase text-medium">Service apres vente L'informaticien de confiance</h1>
<span>Work is easy when you have all tools around you!</span></div>
</div>
</section>
<br>
<br>
